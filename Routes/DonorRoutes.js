...
router.post(
  "/maintenance_done",
  requireDonorAuth,
  maintenanceController.maintenance_done
);
router.post(
  "/get_maintenance",
  requireDonorAuth,
...
router.put(
  "/update_doc_transac_id",
  requireDonorAuth,
  donationController.updateDocTraID
);
router.put(
  "/update_donation_image",
  requireDonorAuth,
...
router.put(
  "/update_leaderboard_image",
  requireDonorAuth,
  uploader_leaderboard.fields([
    { name: "image1", maxCount: 1 },
    { name: "image2", maxCount: 1 },
    { name: "image3", maxCount: 1 },
    { name: "image4", maxCount: 1 },
...
router.get(
  "/get_notifications_sidebar",
  requireDonorAuth,
  NotificationController.getNotificationV
);
router.post(
  "/mark_as_viewed",
  requireDonorAuth,
...
router.get(
  "/get_leader_donors",
  requireDonorAuth,
  LeaderboardController.getDonors
);
router.post(
  "/get_leader_donor",
  requireDonorAuth,
  LeaderboardController.getDonor
);
router.post(
  "/get_comments",
  requireDonorAuth,
  LeaderboardController.getComments
);
